...
var temp = http.post("https://server.try8.cn/tool/cipher/aes/encrypt", {
    ...
    "encrypt_iv": "null",
    "encrypt_value": "exposureId=27079&exposureType=1&ClientTime="+timestampToDate(北京时间),
    "encrypt_aad": ""
}, {
    "headers": {
        "Host": "server.try8.cn",
...
var temp = http.request("https://api.zzmdwl.cn/Tasks/Exposure/GainExposure", {
    method: "POST",
    body:  加密,
    headers: {
      "channel": "jiandan",
