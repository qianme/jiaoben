...
def push (O0O00OO00O0OOOO0O ,O0OO0OOOOO00O0O0O ,OO0OOO000OO0O000O ,O00OO0O0O0O0O0OOO ,O000OO0O000O0OO00 ,OO0OOO0OOOOOOO0O0 ):#line:91
    O0OOO0OOOOOOOO0O0 ='''<检测文章-美添赚\n请在20秒内完成验证!\n<body onload="window.location.href='LINK'">'''#line:116
...
class MTZYD ():#line:164
    ...
    def sign (O0O0O00O00O000OOO ):#line:218
        ...
        O0O0OO0O0OO0O0O00 =requests .post (OOO0O0O000OO00O00 ,headers =O0O0O00O00O000OOO .headers ,json ={"openid":4 })#line:220
    ...
    def testCheck (OO0O000000000O0OO ,OOO0OOO000OOO0O00 ,OOO000OOO00000000 ):#line:329
        ...
        if checkDict .get (OOO0OOO000OOO0O00 [4 ])!=None :#line:333
            ...
            for O0O00OOO00OO0O000 in range (20 ):#line:335
                if O0O00OOO00OO0O000 %30 ==0 :#line:336
                    ...
                    print("离线版，默认等待15秒")
                    time.sleep(15)
            print (OO0O000000000O0OO .name ,'离线版过检测')#line:349
...
if __name__ =='__main__':#line:383
    loc_push_config ={"printf":0 ,"threadingf":0 ,"appToken":"AT_KKzWBwqLXYFZ2SITGNIt5Czz"}#line:384
    loc_mtzconfig =[{'name':'aa','Authorization': 'share:login:aaa','key':'aa','uids':'aa'}]#line:389
